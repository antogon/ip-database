...
# Options:
# Show, Edit, Destroy, Create, New and Update options are included for each entry.
# New Device Type button provided as an option for user to add a new device type. 
# Table entries show: ID, Names and when entries was created or updated. 
